...
- `architecture/` explains implementation boundaries and runtime mechanisms.
- `design/` records UI and accessibility rules.
- `development/` contains setup, build, testing, and debugging guidance.

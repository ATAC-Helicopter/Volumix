...
- **0.5:** Polished mixer and tray UI.
- **0.6:** ALSA MIDI, MIDI Learn, and pickup mode.
- **0.7+:** Profiles, groups, reliability, packaging, and public beta work.

Roadmap order is directional. `TECH_SPEC.md` contains acceptance criteria and remains authoritative.
